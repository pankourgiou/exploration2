...
background = pygame.image.load("moon_caves_tesla_machine.png")  # Make sure you have an image file
...
locations = [
    ...
    {"name": "C", "event": "Moon are those caves empty??? Not so sure...", "x": 300, "y": 200},
